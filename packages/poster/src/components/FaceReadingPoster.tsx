...
import { EyebrowIcon } from '../icons/EyebrowLine';
import { EyeIcon } from '../icons/EyeLine';
import { NoseIcon } from '../icons/NoseLine';
import { MouthIcon } from '../icons/MouthLine';
...
export interface FaceReadingPosterData {
...
export function FaceReadingPoster({ data, qrDataUrl, date, source = 'web' }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Module 1: Left face outline + Right overview */}
      ...
      {/* Module 2: Main facial features */}
      <Card index={2} heading="五官解读">
        {data.mainLines.map((line, i) => {
          const Icon = FACE_LINE_ICONS[line.icon] ?? EyeIcon;
          return (
